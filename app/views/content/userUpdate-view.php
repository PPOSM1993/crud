    ...
    <div class="container is-fluid mb-6">
        <?php 
            ...
            if($id == $_SESSION['id']) { 
        ?>
        <h1 class="title" style="text-align: center;">Mi cuenta</h1>
        <h2 class="subtitle" style="text-align: center;">Actualizar cuenta</h2>
        <?php } else { ?>
        <h1 class="title" style="text-align: center;">Usuarios</h1>
        <h2 class="subtitle" style="text-align: center;">Actualizar usuario</h2>
        <?php } ?>
    </div>
        -->
    <div class="container pb-6 pt-6">
        ...
        <h2 class="title has-text">Nombre Usuario: <?php echo $datos['usuario_nombre']." ".$datos['usuario_apellido']; ?></h2>
        <br>
        <p class="has-text pb-6"><?php echo "<strong>Fecha Creación:</strong> ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_creado']))." &nbsp;"; ?></p>

        <p class="has-text pb-6"><?php echo " <strong>Actualización Usuario:</strong> ".date("d-m-Y  h:i:s A",strtotime($datos['usuario_actualizado'])); ?></p>
